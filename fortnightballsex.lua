...
if not getgenv or (identifyexecutor and identifyexecutor():find("Fluxus")) then
...
entity = funcs:run(funcs:require("https://raw.githubusercontent.com/skyswastaken/VapeV4ForRoblox/main/Libraries/entityHandler.lua", true, true))
